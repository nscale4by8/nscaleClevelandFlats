...
![](https://www.wcpo.com/news/insider/redevelop-tristate-threatened)
...
Even though the Crosley Building is hundreds of miles from the Cleveland Flats, it is a spiritual neighbor. It was a rail served industry incorporating street running and a corner "notch" where rail cars pass through. It fits the "Annex" N-Track module's aesthetic.

![](./Crosley_setting.png)

The prototype Crosley Building features one tower. The model has two towers for two reasons: 1) The model faces away from the front of the module, but the tower is its signature feature, so it is modelled with a tower on front for accuracy and on the back for visual appeal. 2) I glued the roof on 180 deg. wrong and didn't notice until after the glue set. My wife suggested adding the second tower to make the roof symmetrical placing the second tower where the first should have been.

![](./Crosley_birdsEye.png)

Rusty Stack         |   Details                  
:----------------------------------:|:----------------------------------:
![](Crosley_stack.png) |  ![](Crosley_stack2.png)
